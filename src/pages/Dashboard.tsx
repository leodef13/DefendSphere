  ...
  return (
    <div className="space-y-6">
      ...
      <section className="grid grid-cols-1 xl:grid-cols-2 gap-4">
        <Card>
          <CardHeader className="p-4 pb-0">
            <h3 className="text-sm font-medium text-gray-600 dark:text-neutral-300">Threats Over Time</h3>
          </CardHeader>
        ...
        <Card>
          <CardHeader className="p-4 pb-0">
            <h3 className="text-sm font-medium text-gray-600 dark:text-neutral-300">Threat Types</h3>
          </CardHeader>
          <CardContent className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
      ...
      <section>
        <Card>
          <CardHeader className="p-4 pb-0">
            <h3 className="text-sm font-medium text-gray-600 dark:text-neutral-300">Recent Incidents</h3>
          </CardHeader>
          <CardContent className="overflow-x-auto p-0">+            <table className="min-w-full text-sm">
